          ...
          <div>
            <div className="me-top-section">
              <div  className="me-top-section-text">
                ...
                <p>
                  ...
                  representation of oneself in a few lines on a webpage. I could
                  tell you that I’m 27 years old and moved to Gothenburg five
                  years ago, but it would hardly represent the multidisciplinary
                  nature of my passions and competens. We all have multiple
                  aspects to our character, and here are some of mine.
                </p>
              </div>
            ...
            <div className="me-designer me-icon-alignment">
              ...
              <div>
                ...
                <p>
                  I love brainstorming and prototyping interesting concepts and
                  find it extremely satisfying to develop and iterate upon an
                  idea into a refined and beautiful experience.{" "}
                </p>
              </div>
            </div>
            ...
            <div className="me-frontend me-icon-alignment">
              ...
              <div>
                ...
                <p>
                  ...
                  pleasure. It’s incredibly gratifying to construct and develop
                  the design you’ve created into a working deployed product.
                  Academically I’ve steered into projects involving code and
                  I've been a hobbyist programmer for over five years.{" "}
                </p>
              </div>
            </div>
            ...
            <div className="me-cognitive me-icon-alignment">
              ...
              <div>
                ...
                <p>
                  ...
                  behaviors and the discipline of Cognitive Science fit me like
                  a glow. The scientifical backbone of the discipline has to
                  great extent shaped how I perceive and manage the tasks around
                  me.{" "}
                </p>
              </div>
            </div>
