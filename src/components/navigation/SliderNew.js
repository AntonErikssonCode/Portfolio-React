import classes from "./SliderNew.module.css";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div  ref={sliderRef} className={`${classes.sliderBarDiv} ${
            silderDown ? classes.sliderBarDivDown :  classes.sliderBarDivUp
          }`}>

       
        <div
         
          className={`${classes.sliderBar} ${silderDown ? classes.sliderBarDown :  classes.sliderBarUp}`}
        >
          <div
          ...
          <div id="slider" className={`${classes.slider} ${
              silderDown ? classes.sliderSelectorDown : classes.sliderSelectorUp
            }`}>
            <h2>PAST</h2>
          </div>
        </div>
