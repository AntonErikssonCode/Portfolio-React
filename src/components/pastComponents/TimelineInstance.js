...
const data = [
  ...
  },
  {
    ...
    description: [
      "Explored the world and met different cultures and customs.",
      "Worked jobs such as waiter, cleaner and farmer. ",
    ],
  ...
  },
  {
    ...
    description: [
      "Helped customers with everything from invoices, technical issues to sales of hardware and services. ",
      "Handled communication by phone, chat, mail and post. ",
    ],
    type: "Working",
  ...
  },
  {
    ...
    lessons:
      "Heuristics Analysis, Scientific Methodology, Critical Thinking & Project Execution.",
    description: [
      "Gained knowledge of a multitude of cognitive processes, such as perception, attention and memory, and how they are integrated in the human mind.",
      "Got more involved in coding and the underlying structures of AI and Big data. ",
  ...
  },
  {
    ...
    description: [
      "Gaining a deeper understanding of the design process and developing my skills in prototyping, wireframing, user research and information visualization. ",
      "Have intentionally sought after and included courses that involve coding, such as Computer Graphics and Web Development: Scripts and Databases.",
    ],
    type: "Studying",
    location: "Gothenburg",
  ...
  return (
    <div className="timelineInstance">
      <div className="timelineInstance-left">
        <img
          className="timelineInstance-left-img"
      ...
      <div className="timelineInstance-right">
        ...
        <ul className="timelineInstance-list">
          {selectedInstance[0].description.map(function (item, i) {
            return (
              <li className="timelineInstance-list-item" key={i}>
                {item}
              </li>
            );
          })}
        </ul>
        <div className="timelineInstance-lessons-container">
          <h4 className="timelineInstance-lessons">
            {selectedInstance[0].lessons}
          </h4>
        </div>
      </div>
    </div>
